            ...
            {!WMobile ? (
                ...
                <>
                    <nav className="flex flex-row fixed justify-center items-center bottom-0 bg-[#000000] dark: bg-opacity-20 w-full ml-[-10px] space-x-5">
                        ...
                        <a className="flex flex-col items-center px-2 py-2 mt-3 text-black duration-300 transform rounded-lg dark:text-black hover:bg-[#1E6CB1] dark:hover:bg-[#1E6CB1] dark:hover:bg-opacity-50 hover:bg-opacity-50 dark:hover:text-[#1E6CB1] hover:text-[#1E6CB1]" href="#">
