                        ...
                        <div className="flex">
                            ...
                            {isContainerVisible && (
                                <div className="container2 flex flex-row absolute   ">
                                    <GoPencil onClick={toggleCard} className="text-2xl absolute border-[1px] ml-[110px] rounded-full border-black ml-[130   px] mt-[18px]" />
                                    <img className="object-cover mt-[20px] ml-11 w-24 h-24 mx-2 rounded-full " src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar" />
                                    <div className="ml-5">
                            ...
                            {isCardVisible && (
                                <div className={`bg-white shadow-md rounded px-8 pt-6 pb-8  ${isCardVisible ? '' : 'blur'}`}>
                ...
                <div className="flex flex-row">
                    ...
                    <div className="flex w-screen rounded-3xl bg-[#D9D9D9] mx-4 mt-2">
                        <div className="flex">
                            ...
                            {isContainerVisible && (
                                <div className={`container2 flex flex-row absolute ${isCardVisible ? 'blur' : ''}`}>
                                    <GoPencil onClick={toggleCard} className="text-2xl absolute border-[1px] ml-[110px] rounded-full border-black mt-[18px]" />
