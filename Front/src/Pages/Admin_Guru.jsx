  ...
  return (
    <>
      <div className="flex flex-col h-screen">
        ...
        <div className="flex flex-col w-screen item-centers h-screen bg-[#D9D9D9] mx-4 rounded-3xl">
          ...
          <div className="flex flex-row w-auto mx-4">
            ...
            <button className="flex flex-row bg-[#1E6CB1] w-40 h-10 ml-auto mt-20 items-center rounded-[10px]">
              ...
              <div class="py-2 inline-block min-w-full sm:px-8 lg:px-10">
                <div class="overflow-hidden">
                  <table class="min-w-full">
                    ...
                    <tbody className="bg-white" style={{ borderRadius: '24px' }}>
                      <tr class="" style={{ borderRadius: '24px' }}>
                        ...
                        <td class="text-sm text-gray-900 font-medium px-4 py-2 space-x-0">
                          <div className="flex flex-row ml-auto">
                            ...
                            <BsFillTrash3Fill className="w-7 h-7 bg-gray-400 bg-opacity-50 rounded-lg px-1 ml-auto" color="#FF0000" />
                          </div>
                        </td>
                      </tr>
                    </tbody>
