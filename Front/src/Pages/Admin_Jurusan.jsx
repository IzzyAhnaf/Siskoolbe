    ...
    <>
      ...
      <div className="flex flex-col w-[1130px] item-centers h-screen bg-[#D9D9D9] mx-4 rounded-3xl">
        <div className="flex flex-row mt-12 space-x-2 mx-6">
          <GiTrumpetFlag className="w-12 h-12 bg-white rounded-full px-2" style={{ color: '#1E6CB1' }} />
        ...
        <div className="flex flex-row w-auto mx-4">
          ...
          <button className="flex flex-row bg-[#1E6CB1] w-40 h-10 ml-[650px] mt-20 items-center rounded-[10px]"
            onClick={() => navTo('/Siskoolbe/TambahJurusan')}>
            <FaPlus className="ml-3" style={{ color: '#FFFF' }} />
            <span className="text-white mx-2 font-inter text-sm">Tambah Jurusan</span>
          </button>
        </div>
        <div className="flex flex-row mt-8 mx-8 space-x-64">
          ...
          <span className="font-semibold font-inter text-lg mt-2">Urutan Jurusan</span>
        </div>
        <div className="flex flex-row mt-5 mx-6 bg-white rounded-xl h-16 items-center w-auto">
          ...
          <div className="flex flex-row mx-16">
            ...
            <span className="font-inter font-semibold text-lg mx-3 mt-2">Pengembangan Perangkat Lunak Dan Gim</span>
          </div>
          <span className="font-inter font-semibold text-lg ml-10 mt-2">1</span>
          <div className="flex flex-row ml-64 space-x-5">
            <RiPencilFill className="w-8 h-8 bg-gray-400 bg-opacity-50 rounded-lg px-1 ml-auto" color="#1E6CB1" onClick={() => navTo('/Siskoolbe/Edit_Jurusan')} />
