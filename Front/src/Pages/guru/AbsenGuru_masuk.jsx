      ...
      {!WMobile ? (
        defaultCenter && (
          <div className='flex flex-col w-full items-center justify-center rounded-lg h-full bg-[#D9D9D9] mx-4'>
            <div className="flex bg-sky-700 mt-4 w-11/12 mx-10 h-16 rounded-3xl items-center px-12 py-2"
            ...
            <button className="absolute bottom-36 right-0 mr-32"><RiFocus3Line className='w-12 h-12 absolute bg-white rounded-full px-2' style={{color:'#1E6CB1'}} onClick={handleFocusUserLocation}/></button>      
            <button onClick={handleAbsenClick} className='bg-[#269400] text-white rounded-md py-2 mt-5 content-center text-base w-11/12 text-center mx-10'>
              Absen Masuk
            </button>
          </div>
        )
