      ...
      {!WMobile ? (
        <div className="flex flex-row">
          <aside className="flex flex-col h-[620px] mt-2 px-4 py-8 overflow-y-auto rounded-3xl bg-sky-700">
            ...
            <div className="flex flex-row justify-center flex-1 mt-6">
              <nav>
                <Link className="flex flex-col items-center px-4 py-2 mt-5 text-gray-700  bg-gray-100 duration-300 transform rounded-lg dark:text-gray-100 hover:bg-gray-300 hover:bg-opacity-50 dark:hover:text-gray-100 hover:text-gray-100" to="/Siskoolbe">
                ...
                <Link className="flex flex-col items-center px-4 py-2 mt-2 text-gray-100 rounded-lg dark:bg-gray-100 dark:bg-opacity-50 dark:text-gray-200 hover:bg-gray-300 hover:bg-opacity-50 dark:hover:text-gray-100 hover:text-gray-100" to="./Profile">
          ...
          <div className="flex flex-col w-screen rounded-3xl bg-[#D9D9D9] mx-6 mt-2">
            ...
            <div className="flex flex-row bg-sky-700 mt-4 w-[850px] mx-[120px] h-16 rounded-3xl items-center px-4 py-2 ">
            ...
            <div className="flex flex-row bg-white mt-2 w-[850px] mx-[120px] h-20 rounded-3xl">
              ...
              <button className="flex flex-col items-center justify-center mt-3 bg-slate-400 bg-opacity-50 rounded-xl px-6 h-14 py-1 border-solid border-[#269400] border-2 ml-[420px] hover:underline" href="#">
        ...
        <>
          <div className="flex flex-col">
            ...
            <div className="flex flex-col w-11/12 rounded-3xl bg-[#D9D9D9] mx-4 pb-16 mt-4">
              ...
              <div className="flex flex-row bg-white mt-2 w-[315px] mx-6 h-16 rounded-xl">
                <div className="flex flex-col items-center justify-center bg-[#05FF00] bg-opacity-60 mx-4 px-4 rounded-xl py-1 h-12 mt-2">
                ...
                <div className="flex flex-col items-center justify-center ml-20">
                  <span className="font-inter font-bold text-xs text-[#269400]">Masuk</span>
                  <span className="font-inter font-bold text-xs text-[#269400] mt-2">08.00</span>
                </div>
                <span className="text-5xl font-thin mt-1 ml-4">|</span>
                <button className="flex flex-col items-center justify-center mt-3 bg-slate-400 bg-opacity-50 rounded-xl px-3 h-11 py-1 border-solid border-[#FF0000] border-[3px] ml-1 hover:underline" href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 2048 2048"><path fill="#FF0000" d="M1600 896q40 0 75 15t61 41t41 61t15 75v384q0 119-45 224t-124 183t-183 123t-224 46q-144 0-268-55t-226-156l-472-472q-28-28-43-65t-15-76q0-42 16-78t43-64t63-42t78-16q82 0 141 59l107 106V853q-59-28-106-70t-80-95t-52-114t-18-126q0-93 35-174t96-143t142-96T832 0q93 0 174 35t143 96t96 142t35 175q0 93-37 178t-105 149q35 9 63 30t49 52q45-25 94-25q50 0 93 23t69 66q45-25 94-25M512 448q0 75 34 143t94 113V448q0-40 15-75t41-61t61-41t75-15q40 0 75 15t61 41t41 61t15 75v256q60-45 94-113t34-143q0-66-25-124t-69-101t-102-69t-124-26q-66 0-124 25t-102 69t-69 102t-25 124m1152 640q0-26-19-45t-45-19q-34 0-47 19t-16 47t-1 62t0 61t-16 48t-48 19q-37 0-50-23t-16-60t2-77t2-77t-15-59t-51-24q-34 0-47 19t-16 47t-1 62t0 61t-16 48t-48 19q-37 0-50-23t-16-60t2-77t2-77t-15-59t-51-24q-34 0-47 19t-16 47t-1 62t0 61t-16 48t-48 19q-26 0-45-19t-19-45V448q0-26-19-45t-45-19q-26 0-45 19t-19 45v787q0 23-8 42t-23 35t-35 23t-42 9q-22 0-42-8t-37-24l-139-139q-21-21-50-21t-50 21t-22 51q0 29 21 50l472 473q84 84 184 128t219 45q93 0 174-35t142-96t96-142t36-175z"></path></svg>
                  <span className="font-inter font-semibold text-[10px] text-[#FF0000]">masuk</span>
                </button>
              </div>
              <div className="flex flex-row bg-white mt-2 w-[315px] mx-6 h-16 rounded-xl">
                <div className="flex flex-col items-center justify-center bg-[#05FF00] bg-opacity-60 mx-3 px-4 rounded-xl py-1 h-12 mt-2">
                  <span className="font-inter font-semibold text-[12px] text-slate-950">2</span>
                  <span className="font-inter font-semibold text-[12px] text-slate-950">Selasa</span>
                </div>
                <button className="flex flex-col items-center justify-center mt-3 bg-slate-400 bg-opacity-50 rounded-xl px-3 h-11 py-1 border-solid border-[#269400] border-[3px]  ml-16 hover:underline" href="#">
          ...
          <nav className="flex absolute justify-center items-center bottom-0 bg-[#000000] bg-opacity-20 w-screen">
            <a className="flex flex-col items-center px-2 py-2 text-black bg-gray-100 rounded-lg dark:bg-[#1E6CB1]  dark:bg-opacity-50 dark:text-black mt-3" href="#">
              <svg className="w-5 h-5" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 1024 1024"><path fill="#1E6CB1" d="M946.5 505L534.6 93.4a31.93 31.93 0 0 0-45.2 0L77.5 505c-12 12-18.8 28.3-18.8 45.3c0 35.3 28.7 64 64 64h43.4V908c0 17.7 14.3 32 32 32H448V716h112v224h265.9c17.7 0 32-14.3 32-32V614.3h43.4c17 0 33.3-6.7 45.3-18.8c24.9-25 24.9-65.5-.1-90.5"></path></svg>
