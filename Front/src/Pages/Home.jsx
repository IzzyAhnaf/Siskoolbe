...
const Homes = ({nama, token}) => {
  ...
  const getdataAbsen = _debounce(async () => {
    try{
      const resp = await api.get('/absensiswa', {
        headers: {
          Authorization: `${token}`
        }
      })
  ...
  return (
    <>
      {!WMobile ? (
        <div className="flex flex-col w-screen rounded-3xl bg-[#D9D9D9] mx-4 font-inter">
          <div className="flex justify-between bg-white mt-12 mx-[120px] h-48 rounded-3xl">
            <div className="flex flex-col">
              <span className="font-semibold font-inter text-lg mt-8 mx-6">Welcome {nama}</span>
              <span className="font-semibold text-[#AE9D9D] font-inter text-[20px] mt-6 mx-6 w-[500px]">semangatmu adalah kunci untuk meraih impianmu! dengan absensi ini adalah bukti kedisiplinanmu</span>
            </div>
          ...
          <div className="flex bg-white mt-2 mx-[120px] justify-between h-20 rounded-3xl">
            ...
            <div className="flex mx-6">
              ...
              {entry.izin !== 'tanpa_keterangan' && entry.izin !== 'sakit' && entry.izin !== 'keterangan' ? (
              <>
              
              {entry.absen_masuk === '' ? (
              <div className="outline outline-1 outline-[#269400] p-2 rounded-2xl py-1 px-6 mx-2 my-3 items-center flex flex-col cursor-pointer hover:bg-gray-100"
              ...
              <div className="p-2 rounded-2xl py-1 px-6 mx-2 my-3 items-center flex flex-col cursor-pointer">
                ...
                <span className="font-inter font-bold text-lg text-[#269400]">
                  {new Date(entry.absen_keluar).toLocaleTimeString("id-ID", {hour: '2-digit', minute: '2-digit'})}
                </span>
              </div>
              )}
              ...
              <div className="p-2 rounded-2xl py-1 px-6 mx-2 my-3 items-center flex flex-col cursor-pointer">
                <span className="font-inter font-bold text-lg text-[#269400]">Masuk</span>
                <span className="font-inter font-bold text-lg text-[#269400]">--</span>
              </div>
              ...
              <div className="p-2 rounded-2xl py-1 px-6 mx-2 my-3 items-center flex flex-col cursor-pointer">
                <span className="font-inter font-bold text-lg text-[#ff1100]">Keluar</span>
                <span className="font-inter font-bold text-lg text-[#ff1100]">--</span>
              </div>
              </>
              )}
            </div>
        ...
        <>
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col w-[364px]   rounded-3xl bg-[#D9D9D9] pb-12 mt-4 mx-[5px]">
