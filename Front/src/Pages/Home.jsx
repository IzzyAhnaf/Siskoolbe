...
const Homes = () => {
  return (
    <div className="flex flex-row">
      <aside className="flex flex-col h-[620px] mt-2 px-4 py-8 overflow-y-auto rounded-3xl bg-sky-700 ml-2">
        ...
        <div className="flex flex-row justify-center flex-1 mt-6">
          <nav>
            <a className="flex flex-col items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-100 dark:bg-opacity-50 dark:text-gray-200 hover:bg-gray-300 hover:bg-opacity-50 dark:hover:text-gray-100 hover:text-gray-100" href="">
