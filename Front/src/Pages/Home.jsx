  ...
  return (
    <>
      {!WMobile ? (
        ...
        <div className="flex flex-row bg-sky-700 mt-4 w-[315px] mx-6 h-12 rounded-3xl items-center px-4 py-2 mt-4">
          <svg className="w-7 h-7" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512"><path fill="white" d="M256 32C167.67 32 96 96.51 96 176c0 128 160 304 160 304s160-176 160-304c0-79.49-71.67-144-160-144m0 224a64 64 0 1 1 64-64a64.07 64.07 0 0 1-64 64"></path></svg>
        ...
        <nav className="flex absolute justify-center items-center bottom-0 bg-[#000000] bg-opacity-20 w-screen">
                <a className="flex flex-col items-center px-2 py-2 text-black bg-gray-100 rounded-lg dark:bg-[#1E6CB1] bg-[#1E6CB1] dark:bg-opacity-50 dark:text-black mt-3" href="#">
