...
const Homes = ({nama, token, WMobile, DekstopLow}) => {
            ...
            <div className="flex bg-white mt-2 mx-[120px] justify-between h-20 rounded-3xl" key={index}>
              ...
              <div className="flex mx-6">
                ...
                {entry.absen_masuk === '' || !entry.absen_masuk  ? (
                  ...
                  <>
                  <div className="p-2 rounded-2xl py-1 px-6 mx-2 my-3 items-center flex flex-col">
                    <span className="font-inter font-bold text-lg text-[#ff1100]">Masuk</span>
                ...
                {entry.izin === 'sakit' || entry.izin === 'keterangan' ? (
                  <div className="p-2 rounded-2xl py-2 px-6 mx-2 my-4 items-center flex flex-col bg-[#ffec1c] justify-center cursor-pointer" onClick={() => navTo(`/Siskoolbe/Absen/${entry.id}`)}>
