      ...
      {!WMobile ? (
        defaultCenter && (
          <div className='flex flex-col w-screen item-centers justify-center h-screen bg-[#D9D9D9] mx-4'>
            ...
            <MapContainer className="justify-center items-center w-11/12 h-3/4 rounded-xl mx-10"
            ...
            <button onClick={handleAbsenClick} className='bg-[#269400] text-white rounded-md py-2 px-5 mt-5 content-center text-base w-94 text-center mx-56'>Absen Masuk</button>
          </div>
        )
      ) : (
        <>
        {defaultCenter && (
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col items-center rounded-xl bg-[#D9D9D9] w-11/12 justify-center h-[470px] pb-6 mx-2 mt-1">
            <MapContainer className="justify-center items-center w-full h-96"
                center={defaultCenter}
                zoom={17}
                scrollWheelZoom={false}
